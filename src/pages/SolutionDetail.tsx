...
import scoringLeadQualificationIndia from "@/assets/scoring-lead-qualification-india.png";
...
const solutionLinks: Record<string, string> = {
  ...
  "personal-loan-india":"https://bfsi.searchunify.com/resources/search_clients_custom/394e3b27-29bf-11f1-8f52-0242ac120013/download/index.html?searchString=&activeType=all&from=0&sortby=_score&orderBy=desc&pageNo=1&aggregations=%5B%5D&uid=4d747e3d-690e-11ef-937c-0242ac120014&resultsPerPage=10&exactPhrase=&withOneOrMore=&withoutTheWords=&pageSize=10&language=en&suCaseCreate=false",
  "personal-loan-usa":"https://bfsi.searchunify.com/resources/search_clients_custom/394e3b27-29bf-11f1-8f52-0242ac120013/download/indexash.html?searchString=&activeType=all&from=0&sortby=_score&orderBy=desc&pageNo=1&aggregations=%5B%5D&uid=4d747e3d-690e-11ef-937c-0242ac120014&resultsPerPage=10&exactPhrase=&withOneOrMore=&withoutTheWords=&pageSize=10&language=en&suCaseCreate=false",
  "gold-loan-india":"https://bfsi.searchunify.com/resources/search_clients_custom/394e3b27-29bf-11f1-8f52-0242ac120013/download/indexgold.html?searchString=&activeType=all&from=0&sortby=_score&orderBy=desc&pageNo=1&aggregations=%5B%5D&uid=4d747e3d-690e-11ef-937c-0242ac120014&resultsPerPage=10&exactPhrase=&withOneOrMore=&withoutTheWords=&pageSize=10&language=en&suCaseCreate=false",
  "home-loan-india":"https://bfsi.searchunify.com/resources/search_clients_custom/394e3b27-29bf-11f1-8f52-0242ac120013/output/index.html?searchString=&activeType=all&from=0&sortby=_score&orderBy=desc&pageNo=1&aggregations=%5B%5D&uid=4d747e3d-690e-11ef-937c-0242ac120014&resultsPerPage=10&exactPhrase=&withOneOrMore=&withoutTheWords=&pageSize=10&language=en&suCaseCreate=false",
  "digital-loan-india":"https://bfsi.searchunify.com/resources/search_clients_custom/394e3b27-29bf-11f1-8f52-0242ac120013/download/indexbank.html?searchString=&activeType=all&from=0&sortby=_score&orderBy=desc&pageNo=1&aggregations=%5B%5D&uid=4d747e3d-690e-11ef-937c-0242ac120014&resultsPerPage=10&exactPhrase=&withOneOrMore=&withoutTheWords=&pageSize=10&language=en&suCaseCreate=false",
  ...
  "health-insurance-sales-usa":"https://bfsi.searchunify.com/bfsi-agentic-suite/health-chat",
  "lead-qualification-india":"https://bfsi.searchunify.com/bfsi-agentic-suite/lic?agentConfig=licSales"
};
...
const solutionData: Record<string, { title: string; description: string; notes?: string; workflow: string }> = {
  ...
  "financial-services-india": {
    title: "Personal Finance Customer Support Assistant (USA)",
  ...
  "lead-qualification-india": {
    title: "Lead Qualification Assistant (India)",
    ...
    notes: "**Note**: This solution is purpose-built for the home/housing loan lead qualification and conversion journey.\n\n**Key Highlights**:\n• Instant lead outreach\n• Multilingual & regional voice\n• 3–5 min structured qualification\n• Real-time CRM sync\n• Intelligent lead routing\n• Built for Home Loans\n\n**Workflow**: New Lead Assigned → AI Voice Agent Calls Lead → Multilingual Qualification Conversation (3–5 min) → Knowledge Base Q&A → Lead Scoring & Categorization (Hot / Warm / Cold / Pending / Urgent) → Real-time CRM Update (score + categories + context) → Smart Routing to Human Team\n\nTo try out the solution, please use any of the following details in the insurance registration form:\n\n**Client 1**:\nName: Arjun Kumar | Mobile Number: 8197162904 | Property Location: Bangalore | Area Office: Koramangala\n\n**Client 2**:\nName: Arvind Shekhar | Mobile Number: 7837678234 | Property Location: Mohali | Area Office: Zirakpur\n\n**Client 3**:\nName: Vikas Singh | Mobile Number: 7092678120 | Property Location: Hyderabad | Area Office: HITEC City\n\n**Client 4**:\nName: Devesh Dixit | Mobile Number: 7820190872 | Property Location: Mumbai | Area Office: Andheri East\n\n**Client 5**:\nName: Rahul Ved | Mobile Number: 6235067123 | Property Location: Delhi | Area Office: Greater Kailash",
